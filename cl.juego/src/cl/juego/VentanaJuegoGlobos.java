...
public class VentanaJuegoGlobos extends JFrame implements ActionListener{
	...
	private static ImageIcon RBin1 = new ImageIcon("boton 1 on.png"); 
	private static ImageIcon RBin1off = new ImageIcon("boton 1 off.png"); 
	private static ImageIcon RBin2 = new ImageIcon("boton 2 on.png"); 
	private static ImageIcon RBin2off = new ImageIcon("boton 2 off.png"); 
	private static ImageIcon RBin3 = new ImageIcon("boton4off.png"); 
	private static ImageIcon RBin3off = new ImageIcon("booton 4 on.png"); 
	private static ImageIcon RBin4 = new ImageIcon("boton8off.png"); 
	private static ImageIcon RBin4off = new ImageIcon("boton 8 on.png"); 
	private static ImageIcon RBin5 = new ImageIcon("boton16off.png"); 
	private static ImageIcon RBin5off = new ImageIcon("boton 16 on.png"); 
	private static ImageIcon RBin6 = new ImageIcon("32 encendido.png"); 
	private static ImageIcon RBin6off = new ImageIcon("32 apagado.png"); 
	...
	public VentanaJuegoGlobos(){
		super("Juego de los Globos");
		setSize(900,600);
   ...
   public JLabel ilumina (JLabel var,JLabel var2 ){
	   
	   if(var.getIcon()==bin1){
		   if(var2.getIcon()==bin1){
			   
		   }
		   if(var2.getIcon()==bin2){
			   
		   }
		   if(var2.getIcon()==bin3){
			   
		   }
		   if(var2.getIcon()==bin4){
			   
		   }
		   if(var2.getIcon()==bin5){
			   
		   }
		   if(var2.getIcon()==bin6){
